...
import 'package:triad_web/pages/two_player_page/states/second_player_triad.dart';
...
class SecondPlayerPlay extends TwoPlayerState {
  ...
  TwoPlayerState? onTilePressed(int x, int y) {
    ...
    if(moveResult.done) {
      ...
      if(moveResult.hasTriad) {
        return SecondPlayerTriad(context, board, player1Dices, player2Dices, text);
      } else {
